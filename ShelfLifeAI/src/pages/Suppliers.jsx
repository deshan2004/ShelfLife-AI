...
function Suppliers({ inventory, onUpdateInventory, showToast, user }) {
    // ============================================================
    // State Management
    // ============================================================
    ...
    const handleAddSupplier = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                const updatedList = [...suppliers, result.supplier]
        ...
        try {
            ...
            if (result.success) {
                const updatedList = suppliers.map(s =>
                    s.id === selectedSupplier.id ? result.supplier : s
                )
                setSuppliers(updatedList)
                saveToLocalStorage(updatedList)
                            ...
                            <div key={supplier.id} className="supplier-card">
                                ...
                                <div className="supplier-products">
                                    <div className="supplier-products-header">
                                        ...
                                        <button className="btn-view-products" onClick={() => {
